...
function ItemsC({ listing, index }: { listing: CISA, index: number }) {
    ...
    return (
        <View style={{ backgroundColor: index % 2 ? '#00ffff60' : '#00ff0f60', margin: 4 }}>
...
function ItemsN({ listing, index }: { listing: NIST, index: number }) {
    ...
    return (
        <View style={{ backgroundColor: index % 2 ? '#ffa00060' : '#ff000060', margin: 4 }}>
        ...
        <View style={{ flex: 1, flexDirection: 'row' }}>
            <View style={{ flex: 1 }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => <ItemsC listing={item} index={index} />}
                />
            </View>
            <View style={{ flex: 1 }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => <ItemsN listing={item} index={index} />}
                />
            </View>
        </View>
    )
